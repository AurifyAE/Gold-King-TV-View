...
let askSpread, bidSpread, goldValue, silverBidSpread, silverAskSpread, goldBuy, goldSell, silverBuy, silverSell, silverValue, goldValueUSD, goldLow, goldHigh;
...
async function readSpreadValues() {
    try {
        const uid = '6zP53dDpnnXDFTnm3wbZgMK5qD02';
        if (!uid) {
